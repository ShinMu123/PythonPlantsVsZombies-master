...
# Tiêu đề cửa sổ (English) và bản tiếng Việt
ORIGINAL_CAPTION = 'Plant VS Zombies Game'
VIET_CAPTION = 'Cây vs Xác sống - Trò chơi'
...
# ===== Thông tin game (KEYS) =====
# Các khóa lưu trữ trạng thái trò chơi
CURRENT_TIME = 'current time'   # thời gian hiện tại (ms)
LEVEL_NUM = 'level num'         # số màn chơi hiện tại

# ===== Các trạng thái chính của game =====
MAIN_MENU = 'main menu'    # màn hình chính
LOAD_SCREEN = 'load screen' # màn hình tải (nếu có)
